...
import { SunSnowIcon, ArrowRightIcon, ZapIcon ,CheckIcon, VideoIcon,Code2Icon, UsersIcon} from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          >
            <div className="size-10 rounded-xl bg-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center shadow-lg">
              <SunSnowIcon className="size-6 text-white" />
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className='flex flex-wrap gap-4'>
                <SignInButton mode='modal'>
                    <button className='btn btn-primary btn-lg rounded-4xl'>
                        Start Coding Now
                        <ArrowRightIcon className='size-5'/>

                    </button>
                </SignInButton>
                <button className='btn btn-outline btn-lg rounded-4xl'>
